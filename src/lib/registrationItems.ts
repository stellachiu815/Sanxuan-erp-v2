...
export const REGISTRATION_ITEM_SEED: readonly RegistrationItemSeed[] = [
  ...
  // 年度燈：四項
  // V41：光明／太歲／祭改 改為「一人一份」（同人同項目不建第二筆；份數仍可多盞）。全家燈本就一人一份。
  { key: "LANTERN_GUANGMING", name: "光明燈", activityType: "GUANGMING_LANTERN", activityGroup: "ANNUAL_LANTERN", activityGroupName: "年度燈", contentKind: "LANTERN", feeMode: "PER_UNIT", defaultUnitPrice: 500, defaultQuantity: 1, allowMultiplePerMember: false, printDocumentKeys: ["GUANGMING_LANTERN_TABLET", "GUANGMING_LANTERN_PETITION"], sortOrder: 1 },
  { key: "LANTERN_TAISUI", name: "太歲燈", activityType: "TAISUI_LANTERN", activityGroup: "ANNUAL_LANTERN", activityGroupName: "年度燈", contentKind: "LANTERN", feeMode: "PER_UNIT", defaultUnitPrice: 500, defaultQuantity: 1, allowMultiplePerMember: false, printDocumentKeys: ["TAISUI_LANTERN_TABLET", "TAISUI_LANTERN_PETITION"], sortOrder: 2 },
  ...
  { key: "LANTERN_PURIFICATION", name: "祭改", activityType: "PURIFICATION", activityGroup: "ANNUAL_LANTERN", activityGroupName: "年度燈", contentKind: "PURIFICATION", feeMode: "NONE", defaultUnitPrice: null, defaultQuantity: 1, allowMultiplePerMember: false, printDocumentKeys: ["PURIFICATION_STICKER"], sortOrder: 4 },
