...
/**
 * 歷代祖先牌位模板（V4.0 建立暫時版型，V4.1 改為可套版）。
 *
...
export default function AncestorLineTablet({ entry }: { entry: PrintTabletEntry }) {
  return (
    <div
      className="tablet-card flex h-full w-full items-center justify-center border-4 border-double border-ink bg-white px-4 py-6"
